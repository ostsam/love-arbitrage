...
export type Volatility = 'LOW' | 'MED' | 'HIGH' | 'EXTREME' | 'CRITICAL';
export type Category = 'Public' | 'Private';
...
export const ALL_ASSETS: Asset[] = [
  {
    ...
    propBets: [
      ...
      { id: '8', question: 'Travis retires from NFL for love?', yesOdds: '12%', noOdds: '88%', volume: '$2.1M', expiry: 'End of Season' },
      ...
      { id: '11', question: 'Seen at an Eras Tour show in Toronto?', yesOdds: '99%', noOdds: '1%', volume: '$10k', expiry: 'Tour Dates' },
      ...
      { id: '18', question: 'Both attend Met Gala 2026?', yesOdds: '50%', noOdds: '50%', volume: '$2M', expiry: 'May 2026' },
      ...
      { id: '23', question: 'Announce a break rather than breakup?', yesOdds: '33%', noOdds: '67%', volume: '$900k', expiry: 'Dec 2026' },
  ...
  },
  {
    ...
    propBets: [
      { id: '7', question: 'Hard-launch new boyfriend by Valentines?', yesOdds: '35%', noOdds: '65%', volume: '$900k', expiry: 'Feb 14' }
    ]
  },
